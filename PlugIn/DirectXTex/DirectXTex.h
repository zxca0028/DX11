...
namespace DirectX
{
    ...
    struct Square
    {
        ...
        Square() = default;
        Square(size_t _x, size_t _y, size_t _w, size_t _h) noexcept : x(_x), y(_y), w(_w), h(_h) {}
    };

    HRESULT __cdecl CopyRectangle(
        _In_ const Image& srcImage, _In_ const Square& srcRect, _In_ const Image& dstImage,
